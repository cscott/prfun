...
module.exports = function(Promise) {
  ...
  Promise.prototype['throw'] = function(e) {
    return this.then(function() { throw e; });
  };
  ...
  // XXX This doesn't actually match synchronous finally.
  // eg:
  ...
  // Error: b
  // This method would return '1' in both cases.
  Promise.prototype.finally = function(handler) {
    var promise = this;
    return new Promise(function(resolve, reject) {
      promise.then(function(value) {
        var cb = function() { resolve(value); };
        Promise.cast().then(handler).then(cb, cb);
      }, function(reason) {
        var cb = function() { reject(value); };
        Promise.cast().then(handler).then(cb, cb);
      });
    });
  };
  ...
  Promise.prototype.nodeify = function(callback) {
    var promise = this;
    if (callback) {
      promise.then(function(v) { callback(null, v); },
