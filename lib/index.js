...
module.exports = function(Promise) {
  ...
  Promise.prototype.all = function() {
    return Promise.resolve(this).then(function(value) {
  ...
  Promise.map = function(pArray, callback, thisArg) {
    return Promise.resolve(pArray).then(function(arr) {
      return Promise.all(arrayMap.call(arr, function(pElem, index, arr_) {
        return Promise.resolve(pElem).then(function(elem) {
  ...
  Promise.props = function(pObj) {
    return Promise.resolve(pObj).then(function(obj) {
      var result = {};
  ...
  var reducer = function(callback) {
    return function(pPrev, pCurrent, index, arr) {
      return Promise.resolve(pPrev).then(function(prev) {
        return Promise.resolve(pCurrent).then(function(current) {
  ...
  Promise.reduce = function(pArray, callback) {
    if (arguments.length <= 2) {
      ...
      var initialValue = Promise.resolve(arguments[2]);
      return Promise.resolve(pArray).then(function(arr) {
  ...
  Promise.prototype.spread = function(onFulfilled, onRejected) {
    var f = onFulfilled ? function(pArgs) {
      return Promise.resolve(pArgs).all().then(function(args) {
  ...
  Promise.delay = function(pValue, ms) {
    ...
    return Promise.resolve(pValue).then(function(value) {
  ...
  Promise.prototype.finally = function(handler) {
    ...
    return new Promise(function(resolve, reject) {
      promise.then(function(value) {
        ...
        Promise.resolve().then(handler).then(cb, reject);
      }, function(reason) {
  ...
  Promise.guard = function(condition, fn) {
    if (typeof condition === 'number') {
      condition = Promise.guard.n(condition);
    }
    return function() {
      var self, args;
      ...
      return Promise.resolve(condition()).then(function(exit) {
        return Promise.resolve(fn.apply(self, args)).finally(exit);
      });
    };
  };
