...
module.exports = function(Promise) {
  ...
  var superThen = Monadic.prototype.then;
  Monadic.prototype.chain = function(f, r) {
    var nf = function(v) { return f.call(this, v[0]); }; // unwrap v
    return superThen.call(this, nf, r);
  };
  Monadic.prototype.then = function(f, r) {
    var nf = function(v) {
      return Promise.resolve(v[0]).then(f, r); // iteratively unwrap
    };
    return superThen.call(this, nf, r);
  };
