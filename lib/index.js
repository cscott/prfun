...
module.exports = function(Promise) {
  ...
  Promise.prototype.all = function() {
    ...
    return P.resolve(this).then(function(value) {
      return P.all(value);
    });
  };
  ...
  Promise.prototype.spread = function(onFulfilled, onRejected) {
    ...
    var f = onFulfilled ? function(pArgs) {
      return P.resolve(pArgs).all().then(function(args) {
  ...
  Promise.prototype.bind = function(newThis) {
    ...
    var BoundPromise = function(exec) {
      return Promise.call(this, exec);
    };
    Object.setPrototypeOf(BoundPromise, Promise);
    BoundPromise.prototype = Object.create(Promise.prototype);
    ...
    return newThis ? BoundPromise.resolve(this) : Promise.resolve(this);
  };
