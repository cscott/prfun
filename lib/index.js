...
module.exports = function(Promise) {
  ...
  var Monadic = Promise.Monadic = function(exec) {
    // create a new subclass to thwart the standard wrapping optimization
    var MP = function(exec) {
      return Promise.call(this, function(f, r) {
        exec(function(v) { f([v]); }, r); // wrap v
      });
    };
    Object.setPrototypeOf(MP, Monadic);
    MP.prototype = Object.create(Monadic.prototype);
  ...
  Monadic.prototype.then = (function(superThen) {
    return function(f, r) {
      var nf = function(v) { return f.call(this, v[0]); }; // unwrap v
      return superThen.call(this, nf, r);
    };
  })(Monadic.prototype.then);

  // XXX Note that I wouldn't have to override `resolve` if it weren't for
  // the strict check in step 8 of CreatePromiseCapabilityRecord.
